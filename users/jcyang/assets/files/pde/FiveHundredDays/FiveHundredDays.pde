/* @pjs font="/users/jcyang/assets/font/ArialRoundedMTBold.ttf, /users/jcyang/assets/font/AvenirNextCondensed-Regular.ttf, /users/jcyang/assets/font/YuKyo_Yoko-Medium.ttc"; */
...
void setup() {
  ...
  pathToMe = "";
  pathToMe = "/users/jcyang/assets/files/pde/FiveHundredDays/";
  readStuff();
